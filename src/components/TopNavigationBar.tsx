  ...
  return (
    <header className="relative z-40 w-full bg-[#0a140e]/95 backdrop-blur-md border-b border-[#1b2f21] px-2.5 sm:px-5 py-2 shadow-2xl font-mono select-none">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-2">
        ...
        {/* Center: Mode Tabs as Clickable Grid Buttons (No Scroll) */}
        <div className="grid grid-cols-3 sm:grid-cols-4 md:flex md:flex-wrap items-center justify-center gap-1.5 bg-[#060e08] p-1.5 rounded-xl border border-[#1b2f21] w-full md:w-auto">
          {navTabs.map((tab) => {
