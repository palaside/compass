...
export default function App() {
  ...
  return (
    <div className="relative w-screen h-[100dvh] bg-[#030704] text-[#10b981] overflow-hidden flex flex-col justify-between font-mono select-none">
      ...
      <main className="relative flex-1 w-full h-full overflow-y-auto overflow-x-hidden">
        {mode === 'AR' && (
          <ARView
            currentPosition={currentPosition}
